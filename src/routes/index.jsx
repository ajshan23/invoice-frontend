...
const PdfForm = lazy(() => import("@/app/(admin)/pdf/PdfForm"));
const AllPdfView = lazy(() => import("@/app/(admin)/pdf/AllPdfView"));
const ViewPdf = lazy(() => import("@/app/(admin)/pdf/ViewPdf"));
const EditPdf = lazy(() => import("@/app/(admin)/pdf/EditPdfForm"));
