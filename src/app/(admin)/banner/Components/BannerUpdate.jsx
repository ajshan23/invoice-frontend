...
import { Card, CardBody, Col, FormControl, Row, Form, Button } from 'react-bootstrap';
...
const ImageCropper = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post('/admin/upload-banner', formData, {
        headers: {
                ...
                <Col lg={3}>
                  ...
                  <div className="docs-data">
                    <Form.Group className="mb-2">
                      ...
                      <Form.Control type="text" value={cropData.cropX} readOnly />
                    </Form.Group>
                    <Form.Group className="mb-2">
                      <Form.Label>Y</Form.Label>
                      <Form.Control type="text" value={cropData.cropY} readOnly />
                    </Form.Group>
                    <Form.Group className="mb-2">
                      <Form.Label>Width</Form.Label>
                      <Form.Control type="text" value={cropData.imageWidth} readOnly />
                    </Form.Group>
                    <Form.Group className="mb-2">
                      <Form.Label>Height</Form.Label>
                      <Form.Control type="text" value={cropData.imageHeight} readOnly />
                    </Form.Group>
                    <Form.Group className="mb-2">
                      <Form.Label>Rotate</Form.Label>
                      <Form.Control type="text" value={cropData.imageRotate} readOnly />
                    </Form.Group>
                    {/* <Form.Group className="mb-2">
                      <Form.Label>Scale X</Form.Label>
                      <Form.Control type="text" value={cropData.scaleX} readOnly />
                    </Form.Group>
                    <Form.Group className="mb-2">
                      <Form.Label>Scale Y</Form.Label>
                      <Form.Control type="text" value={cropData.scaleY} readOnly />
                    </Form.Group> */}
                  </div>
