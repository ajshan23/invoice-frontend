            ...
            <Row className="g-2">
              <Col lg={3} className="d-none d-lg-block">
                <div className="profile-user-img p-2 text-start">
                 {
                  user.profileImage? <img src={`data:image/png;base64,${user.profileImage}`} alt="avatar" className="img-thumbnail avatar-lg rounded" />:<img
                                                      src={NoImg}
                                                      alt="Profile"
                ...
                <div className="pt-3 ps-2">
                  ...
                  <p className="text-muted mb-2 font-13">
                    <strong>Email :</strong> <span className="ms-2">{user?.email??"Not avaialable"}</span>
                  </p>
                  <p className="text-muted mb-1 font-13">
                    <strong>Location :</strong> <span className="ms-2">{user?.profile?.place??"Not avaialable"}</span>
                  </p>
                </div>
